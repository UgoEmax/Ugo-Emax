...
const About = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center text-center pt-70 pb-10 about-section' id='about'>
      ...
      <Image src="/images/form-code.jpg" alt='Code Image' width={400} height={300} className="my-4 rounded-3xl pt-5 about-element" />
    </div>
  )
}
