...
const About = () => {
  return (
    <div className='flex flex-col justify-center items-center text-center pt-20'>
      <h1 className="text-2xl font-bold mb-4 pb-5 text-amber-400">About Me</h1>
      ...
      <Image src="/images/form-code.jpg" alt='Code Image' width={400} height={300} className="my-4 rounded-3xl pt-15 " />
    </div>
  )
}
