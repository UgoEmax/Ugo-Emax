...
const Hero = () => {
  return (
    <div className='w-full h-[100vh] flex flex-col justify-center items-center text-center pt-15'>
      ...
      <Link href="/project" className="mt-4 bg-amber-400 text-black p-3 rounded-md font-semibold hover:bg-amber-500 transition-colors">View My Work</Link>
